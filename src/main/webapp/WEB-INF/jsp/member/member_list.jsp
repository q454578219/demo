    ...
    <table class="layui-table" id="userTable">
        ...
        <%--<tr>--%>
            ...
            <%--<td class="td-manage">--%>
                ...
                <%--</a>--%>
                <%--<a title="编辑" onclick="x_admin_show('编辑','member_edit',600,400)" href="javascript:;">--%>
                    <%--<i class="layui-icon">&#xe642;</i>--%>
                <%--</a>--%>
...
<script>
    ...
    function InitTable(data) {
        for (var i = 0; i < data.length; i++) {
            ...
            var html = '<tr>' +
                ...
                '                <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id=\'2\'><i class="layui-icon">&#xe605;</i>' +
                '                </div>' +
                '            </td>' +makeTd(ob,'id,name,account,password,age,create_time,status')+
                '            <td class="td-manage">'+
                '                <a onclick="member_stop(this,\'10001\')" href="javascript:;" title="启用">' +
                '                    <i class="layui-icon">&#xe601;</i>' +
                '                </a>' +
    ...
    var memberurl = basePath + "showMemberList";
    getAjaxData(memberurl, showMemberList);
</script>
</body>
